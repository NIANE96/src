 ...
 * 
 * @file OccGridMapBase.h
 * Fichier OccGridMapBase h
 * @author NIANE
 * @author DIOUME
 * @author HOURI
 * @author BOUBACAR
...
public:
  ...
  /**
   * Met à jour la carte en utilisant les données de balayage et la pose du robot données.
   * dataContainer Contient les données de balayage laser.
   * @param robotPoseWorld La pose 2D du robot en coordonnées mondiales
   */
